    ...
    return (
        <div className='my-28 '>
            ...
            <div className='flex justify-center'>
                <div class="stats stats-vertical lg:stats-horizontal bg-base-200 shadow pb-20 w-full m-16">

                    <div class="stat">
                        <div class="stat-figure text-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-12 h-12 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>
                        </div>
                    ...
                    <div class="stat">
                        ...
                        <div class="stat-desc">↗︎ 400 (22% higher than last month)</div>
                    </div>
            ...
            <div className='flex justify-center'>
                <div className="card w-3/4 bg-base-300 text-neutral-content mt-[-120px] shadow-2xl">
